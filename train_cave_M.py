...
def save_checkpoint(optimizer, scheduler, path):
    torch.save({
...
if __name__ == '__main__':
    ...
    data_name='cave'
#     path1 = r'pf/code/data/CAVE/train/'
#     path2 = r'pf/code/data/CAVE/test/'
#     path1 = 'pf/code/Data_hsi/CAVE/train/HSI/'
#     path2 = 'pf/code/Data_hsi/CAVE/test/HSI/'
    path1 = 'pf/code/Data_hsi/cave/cave/cave_train/'
    path2 = 'pf/code/Data_hsi/cave/cave/cave_test/'
        ...
        if ((epoch % val_interval == 0) and (epoch >= val_epoch)) or epoch==1 or epoch==EPOCH:
            ...
            with torch.no_grad():
                for i in range(0, len(imglist)):
                    if imglist[i] != '.ipynb_checkpoints':
...
#                         img1 = img['hsi']
                ...
                save_checkpoint(optimizer, scheduler, checkpoint_path + str(epoch) + '.pth')
